...
class TestDexml(unittest.TestCase):
    def test_base(self):
        ...
        self.assertEqual(
            h.render(encoding="utf8"),
            b('<?xml version="1.0" encoding="utf8" ?><hello />'),
        )
        self.assertEqual(
            h.render(encoding="utf8", pretty=True),
            b('<?xml version="1.0" encoding="utf8" ?>\n<hello/>\n'),
        )
        self.assertEqual(h.render(encoding="utf8", fragment=True), b("<hello />"))
        self.assertEqual(
            h.render(encoding="utf8", fragment=True, pretty=True), b("<hello/>\n")
        )

        self.assertEqual(h.render(), "".join(h.irender()))
        self.assertEqual(h.render(fragment=True), "".join(h.irender(fragment=True)))
        self.assertEqual(
            h.render(encoding="utf8"), b("").join(h.irender(encoding="utf8"))
        )
        self.assertEqual(
            h.render(encoding="utf8", fragment=True),
            b("").join(h.irender(encoding="utf8", fragment=True)),
        )
    ...
    def test_unicode_model_tagname(self):
        ...
        class hello(dexml.Model):
            class meta:
                tagname = "hel\N{GREEK SMALL LETTER LAMDA}o"

        h = hello.parse("<hel\N{GREEK SMALL LETTER LAMDA}o />")
        self.assertTrue(h)
        ...
        self.assertRaises(dexml.ParseError, hello.parse, "<hllo />")
        self.assertRaises(
            dexml.ParseError, hello.parse, "<Hel\N{GREEK SMALL LETTER LAMDA}o />"
        )

        h = hello.parse(
            "<hel\N{GREEK SMALL LETTER LAMDA}o>world</hel\N{GREEK SMALL LETTER LAMDA}o>"
        )
        self.assertTrue(h)

        h = hello.parse(
            "<?xml version='1.0' encoding='utf-8' ?><hel\N{GREEK SMALL LETTER LAMDA}o>world</hel\N{GREEK SMALL LETTER LAMDA}o>"
        )
        h = hello.parse(
            "<?xml version='1.0' encoding='utf-16' ?><hel\N{GREEK SMALL LETTER LAMDA}o>world</hel\N{GREEK SMALL LETTER LAMDA}o>"
        )
        self.assertTrue(h)

        h = hello()
        self.assertEqual(
            h.render(), '<?xml version="1.0" ?><hel\N{GREEK SMALL LETTER LAMDA}o />'
        )
        self.assertEqual(
            h.render(fragment=True), "<hel\N{GREEK SMALL LETTER LAMDA}o />"
        )
        self.assertEqual(
            h.render(encoding="utf8"),
            '<?xml version="1.0" encoding="utf8" ?><hel\N{GREEK SMALL LETTER LAMDA}o />'.encode(
                "utf8"
            ),
        )
        self.assertEqual(
            h.render(encoding="utf8", fragment=True),
            "<hel\N{GREEK SMALL LETTER LAMDA}o />".encode("utf8"),
        )
    ...
    def test_unicode_string_field(self):
        ...
        p = Person.parse("<Person name='hel\N{GREEK SMALL LETTER LAMDA}o'/>")
        self.assertEqual(p.name, "hel\N{GREEK SMALL LETTER LAMDA}o")

        p = Person()
        p.name = "hel\N{GREEK SMALL LETTER LAMDA}o"
        self.assertEqual(
            p.render(encoding="utf8"),
            '<?xml version="1.0" encoding="utf8" ?><Person name="hel\N{GREEK SMALL LETTER LAMDA}o" />'.encode(
                "utf8"
            ),
        )
    ...
    def test_namespace(self):
        ...
        print(dexml.__dict__)
        self.assertRaises(dexml.ParseError, hello.parse, "<hello />")
        self.assertRaises(
            dexml.ParseError, hello.parse, "<H:hllo xmlns:H='http://hello.com/' />"
        )
        self.assertRaises(
            dexml.ParseError,
            hello.parse,
            "<H:hello xmlns:H='http://hello.com/'>world</H:hello>",
        )
        ...
        self.assertRaises(
            dexml.ParseError, hello.parse, "<H:hello xmlns:H='http://Hello.com/' />"
        )
        ...
        self.assertEqual(
            h.render(fragment=True), '<H:hello xmlns:H="http://hello.com/" />'
        )
    ...
    def test_base_field(self):
        ...
        self.assertRaises(
            dexml.ParseError, tester.parse, "<tester><value>42</value></tester>"
        )
    ...
    def test_value_fields(self):
        ...
        h = hello.parse(
            "<hello recipient='ryan' sender='lozz' strength='7'><msg>hi there</msg></hello>"
        )
        ...
        self.assertRaises(
            dexml.ParseError,
            hello.parse,
            "<hello xmlns:N='N:' N:recipient='ryan' sender='lozz' strength='7'><msg>hi there</msg></hello>",
        )
        self.assertRaises(
            dexml.ParseError,
            hello.parse,
            "<hello xmlns:N='N:' recipient='ryan' sender='lozz' strength='7'><N:msg>hi there</N:msg></hello>",
        )
        ...
        self.assertRaises(
            dexml.ParseError,
            hello.parse,
            "<hello recipient='ryan' sender='lozz' strength='7'><msg>hi <b>there</b></msg></hello>",
        )
    ...
    def test_string_with_special_chars(self):
        ...
        self.assertEqual(
            l.render(fragment=True),
            "<letter><msg>XML &lt;tags&gt; are fun!</msg></letter>",
        )
        ...
        self.assertEqual(
            u.render(fragment=True), '<update status="feeling &lt;awesome&gt;!" />'
        )
    ...
    def test_cdata_fields(self):
        ...
        u = update(status="feeling <awesome>!")
        self.assertEqual(
            u.render(fragment=True),
            "<update><status><![CDATA[feeling <awesome>!]]></status></update>",
        )
    ...
    def test_model_field(self):
        ...
        p = pets.parse(
            "<pets><person name='ryan' age='26'/><pet name='riley' species='dog' /></pets>"
        )
        ...
        p = pets.parse(
            "<pets><person name='ryan' age='26'/><pet name='riley' species='dog' /><pet name='fishy' species='fish' /><pet name='meowth' species='cat' /><vet name='Nic' /></pets>"
        )
        self.assertEqual(p.person.name, "ryan")
        self.assertEqual(p.pet1.name, "riley")
        self.assertEqual(p.pet2.species, "fish")
        ...
        self.assertRaises(
            dexml.ParseError,
            pets.parse,
            "<pets><pet name='riley' species='fish' /></pets>",
        )
        self.assertRaises(
            dexml.ParseError, pets.parse, "<pets><person name='riley' age='2' /></pets>"
        )
        ...
        self.assertEqual(
            p.render(fragment=True),
            '<pets><person name="lozz" age="25" /><pet name="riley" /></pets>',
        )
        self.assertEqual(
            "".join(p.irender(fragment=True)),
            '<pets><person name="lozz" age="25" /><pet name="riley" /></pets>',
        )
        p.pet2 = pet(name="guppy", species="fish")
        self.assertEqual(
            p.render(fragment=True),
            '<pets><person name="lozz" age="25" /><pet name="riley" /><pet name="guppy" species="fish" /></pets>',
        )
        self.assertEqual(
            "".join(p.irender(fragment=True)),
            '<pets><person name="lozz" age="25" /><pet name="riley" /><pet name="guppy" species="fish" /></pets>',
    ...
    def test_model_field_namespace(self):
        ...
        p = pets.parse(
            "<pets xmlns='http://www.pets.com/PetML'><person name='ryan' age='26'/><pet name='riley' species='dog' /></pets>"
        )
        self.assertEqual(p.person.name, "ryan")
        self.assertEqual(p.pet1.species, "dog")
        self.assertEqual(p.pet2, None)
        ...
        p = pets.parse(
            "<P:pets xmlns:P='http://www.pets.com/PetML'><P:person name='ryan' age='26'/><P:pet name='riley' species='dog' /><P:pet name='fishy' species='fish' /></P:pets>"
        )
        self.assertEqual(p.person.name, "ryan")
        self.assertEqual(p.pet1.name, "riley")
        self.assertEqual(p.pet2.species, "fish")
        ...
        self.assertEqual(
            p.render(fragment=True),
            '<P:pets xmlns:P="http://www.pets.com/PetML"><P:person name="lozz" age="25" /><P:pet name="riley" /></P:pets>',
        )

        p.pet2 = pet(name="guppy", species="fish")
        self.assertEqual(
            p.render(fragment=True),
            '<P:pets xmlns:P="http://www.pets.com/PetML"><P:person name="lozz" age="25" /><P:pet name="riley" /><P:pet name="guppy" species="fish" /></P:pets>',
        )

        p = person.parse(
            '<P:person xmlns:P="http://www.pets.com/PetML" name="ryan" age="26"><status>awesome</status></P:person>'
        )
        self.assertEqual(p.status, None)
        p = person.parse(
            '<P:person xmlns:P="http://www.pets.com/PetML" name="ryan" age="26"><P:status>awesome</P:status></P:person>'
        )
        self.assertEqual(p.status, None)
        p = person.parse(
            '<P:person xmlns:P="http://www.pets.com/PetML" xmlns:S="S:" name="ryan" age="26"><S:sts>awesome</S:sts></P:person>'
        )
        self.assertEqual(p.status, None)
        p = person.parse(
            '<P:person xmlns:P="http://www.pets.com/PetML" xmlns:S="S:" name="ryan" age="26"><S:status>awesome</S:status></P:person>'
        )
    ...
    def test_list_field(self):
        ...
        self.assertRaises(
            dexml.ParseError, pets.parse, "<pets><person name='ryan' age='26' /></pets>"
        )
        self.assertRaises(
            dexml.ParseError,
            pets.parse,
            "<pets><person name='ryan' age='26'/><pet name='riley' species='dog' /><note>too</note><note>many</note><note>notes</note></pets>",
        )
        ...
        self.assertEqual(
            p.render(fragment=True),
            '<pets><person name="lozz" age="25" /><pet name="riley" /><pet name="guppy" species="fish" /><note>noted</note></pets>',
        )
        ...
        p = pets.parse(
            "<pets><person name='ryan' age='26'/><pet name='riley' species='dog' /><rewards><reward date='February 23, 2010'/><reward date='November 10, 2009'/></rewards></pets>"
        )
        print(p.render())
        ...
        self.assertRaises(
            dexml.ParseError,
            pets.parse,
            "<pets><person name='ryan' age='26' /><pet name='riley' species='dog' /><reward date='February 23, 2010'/><reward date='November 10, 2009' /></pets>",
        )
    ...
    def test_list_field_sanity_checks(self):
        class GreedyField(fields.Field):
            def parse_child_node(self, obj, node):
                return dexml.Status.PARSE_MORE

        class SaneList(dexml.Model):
            item = fields.List(GreedyField(tagname="item"))

        self.assertRaises(
            ValueError, SaneList.parse, "<SaneList><item /><item /></SaneList>"
        )
    ...
    def test_list_field_max_min(self):
        try:
            ...
            class MyStuff(dexml.Model):
                items = fields.List(
                    fields.String(tagname="item"), required=False, minlength=2
                )
        ...
        self.assertRaises(
            dexml.ParseError, MyStuff.parse, "<MyStuff><item /><item /></MyStuff>"
        )
        s = MyStuff()
        s.items = ["one", "two"]
        ...
        self.assertEqual(
            MyStuff.parse("<MyStuff><item /><item /></MyStuff>").items, ["", ""]
        )
        self.assertRaises(
            dexml.ParseError, MyStuff.parse, "<MyStuff><item /></MyStuff>"
        )
    ...
    def test_dict_field(self):
        ...
        del o.items["item2"]
        self.assertEqual(
            o.render(fragment=True),
            '<obj><item name="item1"><attr>val1</attr></item></obj>',
        )
        ...
        self.assertEqual(
            o.render(fragment=True),
            '<obj><items><item name="item1"><attr>val1</attr></item></items></obj>',
        )
    ...
    def test_dict_field_sanity_checks(self):
        ...
        self.assertRaises(
            dexml.ParseError,
            MyStuff.parse,
            "<MyStuff><ignoreme /><item name='hi' value='world' /></MyStuff>",
        )
    ...
    def test_dict_field_max_min(self):
        ...
        self.assertEqual(
            len(
                MyStuff.parse(
                    "<MyStuff><item name='hi' value='world' /></MyStuff>"
                ).items
            ),
            1,
        )
        self.assertRaises(
            dexml.ParseError,
            MyStuff.parse,
            "<MyStuff><item name='hi' value='world' /><item name='hello' value='earth' /></MyStuff>",
        )
        s = MyStuff()
    ...
    def test_choice_field(self):
        ...
        self.assertRaises(
            dexml.ParseError, b.parse, "<breakfast><eggs num='2' /></breakfast>"
        )
        ...
        self.assertEqual(
            b.render(fragment=True), '<breakfast><bacon num_rashers="1" /></breakfast>'
        )
    ...
    def test_choice_field_sanity_checks(self):
        ...
        self.assertRaises(
            ValueError, SaneChoice.parse, "<SaneChoice><SaneChoice /></SaneChoice>"
        )
    ...
    def test_list_of_choice(self):
        ...
        b = breakfast.parse(
            "<breakfast><bacon num_rashers='2' /><cereal with_milk='true' /></breakfast>"
        )
    ...
    def test_empty_only_boolean(self):
        ...
        self.assertRaises(
            ValueError,
            toggles.parse,
            "<toggles><toggle_empty>no</toggle_empty></toggles>",
        )
    ...
    def test_XmlNode(self):
        ...
        b = bucket.parse(
            "<B:bucket xmlns:B='bucket-uri'><B:contents><hello><B:world /></hello></B:contents></B:bucket>"
        )
        ...
        self.assertEqual(
            b.contents.childNodes[0].childNodes[0].namespaceURI, "bucket-uri"
        )
        ...
        b = bucket.parse(
            "<bucket xmlns='bucket-uri'><bucket><hello /></bucket></bucket>"
        )
        ...
        b = bucket.parse(
            "<B:bucket xmlns:B='bucket-uri'><ignoreme /><B:contents><hello><B:world /></hello></B:contents></B:bucket>"
        )
        self.assertEqual(b.contents.childNodes[0].tagName, "hello")
    ...
    def test_namespaced_children(self):
        ...
        self.assertEqual(
            n2.render(fragment=True), '<t:nsc xmlns:t="test:"><t:f1>7</t:f1></t:nsc>'
        )
    ...
    def test_order_sensitive(self):
        ...
        j = junk.parse(
            "<junk><name>test1</name><note>note1</note><note>note2</note><amount>7</amount></junk>"
        )
        self.assertEqual(j.name, "test1")
        self.assertEqual(j.notes, ["note1", "note2"])
        self.assertEqual(j.amount, 7)

        j = junk_unordered.parse(
            "<junk><name>test1</name><note>note1</note><note>note2</note><amount>7</amount></junk>"
        )
        self.assertEqual(j.name, "test1")
        self.assertEqual(j.notes, ["note1", "note2"])
        ...
        self.assertRaises(
            dexml.ParseError,
            junk.parse,
            "<junk><note>note1</note><amount>7</amount><note>note2</note><name>test1</name></junk>",
        )
    ...
    def test_namespace_prefix_generation(self):
        ...
        self.assertEqual(
            b1.render(),
            '<?xml version="1.0" ?><y:B xmlns:y="http://yyy"><x:A xmlns:x="http://xxx"><y:a>value</y:a></x:A></y:B>',
        )
        ...
        nsmap["A"] = ["A:"]
        self.assertEqual(
            a1.render(fragment=True, nsmap=nsmap),
            '<A xmlns="T:" A:a="hello" b="world"><c xmlns="">owyagarn</c></A>',
        )
    ...
    def test_parsing_value_from_tag_contents(self):
        ...
        o = obj.parse(
            '<obj id="z108"><attr name="level">6</attr><attr name="descr">description</attr></obj>'
        )
        ...
        self.assertEqual(
            o.render(fragment=True),
            '<obj id="test"><attr name="hello">world</attr><attr name="wherethe">bloodyhellareya</attr></obj>',
        )
    ...
    def test_error_using_undefined_model_class(self):
        ...
        self.assertRaises(
            ValueError, Whoopsie.parse, "<Whoopsie><UndefinedModel /></Whoopsie>"
        )
    ...
    def test_unordered_parse_of_list_field(self):
        ...
        n = Notebook.parse(
            "<Notebook><notes><note>one</note><note>two</note></notes></Notebook>"
        )
        self.assertEqual(n.notes, ["one", "two"])

        Notebook.parse(
            "<Notebook><wtf /><notes><note>one</note><note>two</note><wtf /></notes></Notebook>"
        )
        ...
        self.assertRaises(
            dexml.ParseError,
            Notebook.parse,
            "<Notebook tag='home'><notes><note>one</note><note>two</note></notes></Notebook>",
        )
...
class TestListField(unittest.TestCase):
    ...
    def test_tagname(self):
        ...
        o.fs.append(self.F(name="N1"))
        self.assertEqual(
            o.render(fragment=True), "<obj><L><f><name>N1</name></f></L></obj>"
        )
    ...
    def test_list_and_model_tagnames(self):
        ...
        o.fs.append(FF(name="N1"))
        self.assertEqual(
            o.render(fragment=True), "<obj><L><FF><name>N1</name></FF></L></obj>"
        )
